...
<?php
include_once '../services/api/CategoryRepository.php';
...
if ($descriptionValue) {
    foreach ($categoryList as $key => $category) {
        if (strpos($category['description'], $descriptionValue) === false) {
            unset($categoryList[$key]);
        }
    }
}
                            ...
                            <div class="container">
                                <form id="search" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="description" value="<?= $descriptionValue ?>">
                                    </div>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php foreach ($categoryList as $category) { ?>
                                            <tr>
                                                ...
                                                <td><?= $category['name'] ?></td>
                                                <td><img width="100" src="../../BigMartImage/Category/<?= $category['image'] ?>"></td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="../services/controller/CategoryController.php?action=getById&id=<?= $category['id'] ?>">
                                                                <i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                            <a class="dropdown-item" href="../services/controller/CategoryController.php?action=delete&id=<?= $category['id'] ?>">
