        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Catalog /</span> Unit
                        <a href="create-unit.php" class="btn btn-primary">Create Unit</a>
                    </h4>
                    <div class="card">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                       href="../services/controller/UnitController.php?action=getById&id=<?= $unit['id'] ?>">
                                                        <i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                    <a class="dropdown-item"
                                                       href="../services/controller/UnitController.php?action=delete&id=<?= $unit['id'] ?>">
