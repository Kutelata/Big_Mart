            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Catalog /</span> Provider</h4>
                        <a href="create-provider.php" class="mb-3 btn btn-primary">Create Provider</a>
                        <div class="card">
                            ...
                            <div class="container">
                                <form id="search" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" name="email" value="<?= $emailValue ?>">
                                    </div>
                                    <div class="mb-3">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="../services/controller/ProviderController.php?action=getById&id=<?= $provider['id'] ?>">
                                                                <i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                            <a class="dropdown-item" href="../services/controller/ProviderController.php?action=delete&id=<?= $provider['id'] ?>">
