...
if ($nameValue) {
    foreach ($roleList as $key => $role) {
        if (strpos($role['name'], $nameValue) === false) {
            unset($roleList[$key]);
        }
    }
}
...
$page = ceil($roleCount / $itemPerPage);
$currentPage = isset($_GET['page']) ? (int)$_GET['page'] : 1;
$currentPage = $currentPage > $page ? 1 : $currentPage;
$offSet = $itemPerPage * ($currentPage - 1);

if ($roleCount > $itemPerPage) {
    $roleList = array_slice($roleList, $offSet, $itemPerPage, true);
}
$prePage = $currentPage > 1 ? $currentPage - 1 : false;
$nextPage = $itemPerPage < $roleCount && $currentPage < $page ? $currentPage + 1 : false;
?>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <a href="create-role.php" class="mb-3 btn btn-primary">Create Role</a>
                    <div class="card">
                        <h5 class="card-header"><?= $roleCount . ' records found' ?></h5>
                        <div class="container">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                       href="../../services/controller/RoleController.php?action=getById&id=<?= $role['id'] ?>">
                                                        <i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                    <a class="dropdown-item"
                                                       href="../../services/controller/RoleController.php?action=delete&id=<?= $role['id'] ?>">
