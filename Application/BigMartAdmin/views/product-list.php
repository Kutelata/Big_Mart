...
<?php include_once '../services/api/ProductRepository.php'; ?>
<?php
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php foreach ($productList as $product) { ?>
                                            <tr>
                                                ...
                                                <td><?= $product['name'] ?></td>
                                                <td><img width="100" src="../../BigMartImage/Product/<?= $product['image'] ?>"></td>
                                                <td><?= $product['quantity'] ?></td>
                                                <td><?= $product['price'] . ' ' . $product['unit_id']['value'] ?></td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="../services/controller/ProductController.php?action=getById&id=<?= $product['id'] ?>">
                                                                <i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                            <a class="dropdown-item" href="../services/controller/ProductController.php?action=delete&id=<?= $product['id'] ?>">
