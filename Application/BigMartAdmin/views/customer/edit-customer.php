...
<?php
include_once '../../services/api/repository/CustomerRepository.php';
if (isset($_REQUEST['id'])) {
    $id = $_REQUEST['id'];
    $customerRepository = new CustomerRepository();
    $customerData = $customerRepository->getById($id);
}
?>
<body>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Edit Customer
                    ...
                    <div class="row">
                        <div class="col-xl">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <form action="../../services/controller/CustomerController.php?action=update"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="address" type="text"
                                                      name="address"><?= $customerData['address'] ?></textarea>
                                        </div>
