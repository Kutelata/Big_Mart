...
if (isset($_REQUEST['id'])) {
    ...
    $shippingData = $shippingRepository->getById($id);
}
?>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">Edit shipping
                        <a href="shipping-list.php" class="btn btn-primary">Back</a>
                    </h4>
                    <div class="row">
                        <div class="col-xl">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <form action="../../services/controller/ShippingController.php?action=update"
                                          method="POST" enctype="multipart/form-data">
                                        <input type="hidden" class="form-control" id="id" name="id"
                                               value="<?= $shippingData['id'] ?>"/>
                                        <div class="mb-3">
